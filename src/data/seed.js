...
const TX = [
  { days: 0, h: 8, m: 41, name: 'Lidl Košice – Moldavská', cat: 'potraviny', amt: -28.47, type: 'karta', note: 'POS nákup Košice' },
  { days: 0, h: 7, m: 12, name: 'Slovnaft Košice Južná', cat: 'doprava', amt: -52.3, type: 'karta', note: 'PHM' },
  { days: 1, h: 19, m: 22, name: 'Netflix International', cat: 'zabava', amt: -13.99, type: 'inkaso', note: 'Predplatné' },
  { days: 1, h: 14, m: 5, name: 'Billa Aupark Košice', cat: 'potraviny', amt: -41.18, type: 'karta' },
  { days: 2, h: 12, m: 48, name: 'Hostinec Pivovar Košice', cat: 'restauracie', amt: -36.8, type: 'karta' },
  { days: 3, h: 9, m: 2, name: 'Orange Slovensko', cat: 'telekom', amt: -29.9, type: 'inkaso', note: 'Faktúra' },
  { days: 3, h: 18, m: 33, name: 'Alza Box Košice', cat: 'nakupovanie', amt: -89.9, type: 'karta', note: 'Výdajné miesto' },
  { days: 4, h: 8, m: 10, name: 'DPMK Košice', cat: 'doprava', amt: -16.9, type: 'karta', note: '30-dňový lístok' },
  { days: 5, h: 16, m: 40, name: 'Dr. Max OC Optima', cat: 'zdravie', amt: -14.25, type: 'karta' },
  ...
  { days: 8, h: 13, m: 25, name: 'Tesco Extra Toryská', cat: 'potraviny', amt: -67.42, type: 'karta' },
  { days: 9, h: 19, m: 8, name: 'Cinema City Aupark KE', cat: 'zabava', amt: -18.4, type: 'karta' },
  { days: 10, h: 10, m: 15, name: 'VSE Energia', cat: 'byvanie', amt: -84.3, type: 'inkaso', note: 'Záloha elektrina Košice' },
  { days: 11, h: 9, m: 40, name: 'VVS Košice', cat: 'byvanie', amt: -22.15, type: 'inkaso', note: 'Vodné a stočné' },
  { days: 12, h: 15, m: 2, name: 'Decathlon Košice', cat: 'nakupovanie', amt: -54.99, type: 'karta' },
  { days: 13, h: 12, m: 30, name: 'KFC Aupark Košice', cat: 'restauracie', amt: -12.7, type: 'karta' },
  { days: 14, h: 8, m: 5, name: 'Tatra banka, a.s.', cat: 'poistne', amt: -4.9, type: 'poplatok', note: 'Mesačný poplatok za účet' },
  { days: 15, h: 7, m: 55, name: 'DPMK lístok', cat: 'doprava', amt: -1.3, type: 'karta' },
  { days: 16, h: 18, m: 44, name: 'Reserved OC Optima', cat: 'nakupovanie', amt: -39.99, type: 'karta' },
  { days: 18, h: 9, m: 0, name: 'UNION poisťovňa', cat: 'poistne', amt: -28.4, type: 'inkaso', note: 'Cestovné poistenie' },
  { days: 19, h: 20, m: 21, name: 'Wolt Košice', cat: 'restauracie', amt: -19.6, type: 'karta' },
  { days: 21, h: 11, m: 18, name: 'Kaufland Košice', cat: 'potraviny', amt: -73.11, type: 'karta' },
  { days: 23, h: 8, m: 0, name: 'PixelForge s.r.o.', cat: 'prijem', amt: 2140, type: 'mzda', note: 'Mzda za júl 2026' },
  { days: 24, h: 16, m: 5, name: 'Datart OC Optima', cat: 'nakupovanie', amt: -129.0, type: 'karta' },
  { days: 26, h: 13, m: 40, name: 'Shell Košice Jazerná', cat: 'doprava', amt: -48.2, type: 'karta' },
  { days: 28, h: 10, m: 22, name: 'dm drogerie OC Optima', cat: 'nakupovanie', amt: -23.48, type: 'karta' },
  ...
  { days: 33, h: 17, m: 48, name: 'Tesco Extra Toryská', cat: 'potraviny', amt: -55.2, type: 'karta' },
  { days: 35, h: 12, m: 5, name: 'Villa Regia Košice', cat: 'restauracie', amt: -42.3, type: 'karta' },
  { days: 37, h: 8, m: 20, name: 'VSE Energia', cat: 'byvanie', amt: -84.3, type: 'inkaso' },
  { days: 38, h: 14, m: 0, name: 'Martin Novák', cat: 'prijem', amt: 80, type: 'sepa', vs: '20260708', note: 'Vrátenie pôžičky' },
  { days: 40, h: 11, m: 33, name: 'Lidl Košice – Šaca', cat: 'potraviny', amt: -31.9, type: 'karta' },
  { days: 42, h: 16, m: 10, name: 'Nay OC Optima', cat: 'nakupovanie', amt: -159.0, type: 'karta' },
  { days: 45, h: 7, m: 40, name: 'OMV Košice Južné nábrežie', cat: 'doprava', amt: -61.15, type: 'karta' },
  ...
  { days: 50, h: 13, m: 22, name: 'Billa Mlynská Košice', cat: 'potraviny', amt: -38.64, type: 'karta' },
  { days: 52, h: 10, m: 0, name: 'Tatra banka, a.s.', cat: 'poistne', amt: -4.9, type: 'poplatok', note: 'Mesačný poplatok za účet' },
  { days: 54, h: 18, m: 30, name: 'Costa Coffee Aupark KE', cat: 'restauracie', amt: -6.4, type: 'karta' },
  { days: 57, h: 15, m: 12, name: 'H&M OC Optima', cat: 'nakupovanie', amt: -47.8, type: 'karta' },
  { days: 60, h: 8, m: 55, name: 'Lidl Košice – Moldavská', cat: 'potraviny', amt: -26.33, type: 'karta' },
  ...
  { days: 65, h: 12, m: 40, name: 'Benu Lekáreň Hlavná', cat: 'zdravie', amt: -9.8, type: 'karta' },
  { days: 68, h: 17, m: 5, name: 'Tesco Extra Toryská', cat: 'potraviny', amt: -62.77, type: 'karta' },
  { days: 70, h: 8, m: 0, name: 'VSE Energia', cat: 'byvanie', amt: -84.3, type: 'inkaso' },
  { days: 72, h: 9, m: 0, name: 'PixelForge s.r.o.', cat: 'prijem', amt: 2080, type: 'mzda', note: 'Mzda za máj 2026' },
  { days: 75, h: 14, m: 18, name: 'Planeo Elektro Optima', cat: 'nakupovanie', amt: -44.5, type: 'karta' },
  { days: 78, h: 11, m: 50, name: 'Kaufland Košice', cat: 'potraviny', amt: -49.2, type: 'karta' },
  { days: 80, h: 19, m: 40, name: 'Wolt Košice', cat: 'restauracie', amt: -17.3, type: 'karta' },
  { days: 83, h: 7, m: 30, name: 'Slovnaft Košice Južná', cat: 'doprava', amt: -55.0, type: 'karta' },
  ...
  { days: 94, h: 16, m: 22, name: 'Lidl Košice – Moldavská', cat: 'potraviny', amt: -33.41, type: 'karta' },
  { days: 97, h: 9, m: 0, name: 'PixelForge s.r.o.', cat: 'prijem', amt: 2080, type: 'mzda', note: 'Mzda za apríl 2026' },
  { days: 100, h: 13, m: 10, name: 'Billa Aupark Košice', cat: 'potraviny', amt: -29.88, type: 'karta' },
  { days: 104, h: 18, m: 0, name: 'Cinema City Aupark KE', cat: 'zabava', amt: -15.8, type: 'karta' },
  { days: 108, h: 8, m: 0, name: 'VSE Energia', cat: 'byvanie', amt: -79.9, type: 'inkaso' },
  { days: 112, h: 12, m: 0, name: 'Decathlon Košice', cat: 'nakupovanie', amt: -32.0, type: 'karta' },
  { days: 118, h: 10, m: 15, name: 'Tesco Extra Toryská', cat: 'potraviny', amt: -58.13, type: 'karta' },
  { days: 122, h: 9, m: 0, name: 'PixelForge s.r.o.', cat: 'prijem', amt: 2080, type: 'mzda', note: 'Mzda za marec 2026' },
  { days: 128, h: 15, m: 40, name: 'Alza Box Košice', cat: 'nakupovanie', amt: -64.9, type: 'karta' },
  { days: 135, h: 11, m: 20, name: 'Kaufland Košice', cat: 'potraviny', amt: -44.05, type: 'karta' },
]
